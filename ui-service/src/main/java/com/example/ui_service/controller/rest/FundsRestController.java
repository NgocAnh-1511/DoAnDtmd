...
public class FundsRestController {
    ...
    @Value("${cost-payment.service.url:https://api-gateway-cloud-856180445698.asia-southeast1.run.app}")
    ...
    // In local, this should be https://api-gateway-cloud-856180445698.asia-southeast1.run.app (API Gateway)
